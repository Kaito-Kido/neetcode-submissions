...
class Solution {
    ...
    public TreeNode build(
        ...
        TreeNode leftNode = build(preorder, inorder, preIndex + 1, inLeftIndex, inIndex - 1);
        TreeNode rightNode = build(preorder, inorder, preIndex + 1 + leftSize, inIndex + 1, inRightIndex);
        node.left = leftNode;
